...
9. Lakukan Testing di Local Project Next. 
- Install Dependencies: npm install
- Create user di DBMS : sudo mysql -u root -p
    - CREATE USER 'userwebdinamis_2388010026'@'localhost' IDENTIFIED BY 'User123';
    ![alt text](image-1.png)

    - GRANT ALL PRIVILEGES ON *.* TO 'userwebdinamis_2388010026'@'localhost';
